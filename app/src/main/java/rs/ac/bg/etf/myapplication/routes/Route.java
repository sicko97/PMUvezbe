...
public class Route {
    ...
    public static Route createFromResources(Resources resources , int index){
        ...
        TypedArray lengths = resources.obtainTypedArray(R.array.route_lengths);
        ...
        Route result = new Route(routeLabel +" "+ (index + 1) ,
                                        locations[index],
                                        images.getDrawable(index),
                                        names[index],
                                        lengths.getFloat(index,0),
    ...
    public Route(String label, String location, Drawable image,
